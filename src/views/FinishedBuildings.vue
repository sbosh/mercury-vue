<template>
  <div class="main-content">
    <transition name="fade" v-if="loading && !finishedBuildingsPage">
      <preloader-component />
    </transition>
    <div v-else>
      ...
      <mq-layout mq="sm">
        <finishedbuildings-mobile :pageTitle="this.finishedBuildingsPage['title_' + this.$i18n.locale]" />
      </mq-layout>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    ...mapState({
      finishedBuildingsPage: state => state.pages.finishedBuildingsPage,
      finished: state => state.buildings.finished
    })
  }
}
</script>
